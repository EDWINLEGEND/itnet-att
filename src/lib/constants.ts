...
export const USER_THEMES: Record<string, UserTheme> = {
  ...
  "emp-edwin": {
    name: "Gray",
    pastelBg: "bg-slate-300 hover:bg-slate-400/90 dark:bg-slate-700 dark:hover:bg-slate-600",
    pastelWash: "from-slate-400/80 via-slate-300/40 to-transparent dark:from-slate-700/80",
    headerBg: "bg-slate-300/95 dark:bg-slate-700/90 text-slate-950 dark:text-slate-50",
    badge: "bg-slate-400 text-slate-950 font-bold dark:bg-slate-600 dark:text-slate-100",
    avatarBg: "bg-slate-500 text-white font-bold dark:bg-slate-500 dark:text-white",
    accentText: "text-slate-950 dark:text-slate-100",
    cardTint: "bg-slate-300/80 dark:bg-slate-700/60",
    indicatorBg: "bg-slate-700",
    activeTab: "bg-slate-400 text-slate-950 font-bold shadow-2xs dark:bg-slate-600 dark:text-slate-100",
  },
  "emp-able": {
    name: "Pink",
